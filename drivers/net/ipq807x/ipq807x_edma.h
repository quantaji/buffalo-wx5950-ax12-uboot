...
#define IPQ807X_EDMA_RXDESC_RING_SIZE	128
#define IPQ807X_EDMA_RXFILL_RING_SIZE	128
#else
...
extern int ipq807x_ppe_provision_init(void);
...
extern int ipq807x_uxsgmii_speed_set(int port, int speed, int duplex, int status);
#ifdef CONFIG_BUFFALO_WXR5950AX12
extern void ipq807x_uxsgmii_port_disable(int port);
#endif
...
extern int ppe_uniphy_mode_set(uint32_t uniphy_index, uint32_t mode);
